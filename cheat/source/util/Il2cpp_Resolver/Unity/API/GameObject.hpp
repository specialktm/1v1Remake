...
namespace Unity
{
	...
	public:
		...
		{
			CComponent* ooop = nullptr;
			try {
				ooop = reinterpret_cast<CComponent * (UNITY_CALLING_CONVENTION)(void*, System_String*)>(GameObjectFunctions.m_pGetComponent)(this, IL2CPP::String::New(m_pName));
			}
